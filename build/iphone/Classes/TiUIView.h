...
/**
 Base class for all Borg_Daniel_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Borg_Daniel_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
