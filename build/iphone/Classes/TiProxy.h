...
//Rare exceptions to indicate a bug in the _borg_daniel_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Borg_Daniel_Project4 proxies.
 */
