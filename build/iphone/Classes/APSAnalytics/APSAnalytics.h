 ...
 * to send analytic data that can be viewed on the Borg_Daniel_Project4 Dashboard.
 *
 * For information on getting started with Borg_Daniel_Project4 Platform Services,
