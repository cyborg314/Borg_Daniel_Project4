...
@interface Borg_Daniel_Project4Object : KrollCoverageObject {
#else
@interface Borg_Daniel_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Borg_Daniel_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Borg_Daniel_Project4Object *_borg_daniel_project4;
    KrollObject* console;
	BOOL shutdown;
