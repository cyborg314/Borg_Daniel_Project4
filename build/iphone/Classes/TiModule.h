...
/**
 The base class for all Borg_Daniel_Project4 modules
 */
...
/**
 Borg_Daniel_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Borg_Daniel_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Borg_Daniel_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Borg_Daniel_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Borg_Daniel_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
