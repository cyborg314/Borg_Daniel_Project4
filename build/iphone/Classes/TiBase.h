...
// in simulator we redefine to format for Borg_Daniel_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.borg_daniel_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.borg_daniel_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBorg_Daniel_Project4NativeItemNone = -1, 
	UIBorg_Daniel_Project4NativeItemSpinner = -2,
	UIBorg_Daniel_Project4NativeItemProgressBar = -3,
	
	UIBorg_Daniel_Project4NativeItemSlider = -4,
	UIBorg_Daniel_Project4NativeItemSwitch = -5,
	UIBorg_Daniel_Project4NativeItemMultiButton = -6,
	UIBorg_Daniel_Project4NativeItemSegmented = -7,
	
	UIBorg_Daniel_Project4NativeItemTextView = -8,
	UIBorg_Daniel_Project4NativeItemTextField = -9,
	UIBorg_Daniel_Project4NativeItemSearchBar = -10,
	
	UIBorg_Daniel_Project4NativeItemPicker = -11,
	UIBorg_Daniel_Project4NativeItemDatePicker = -12,
	
	UIBorg_Daniel_Project4NativeItemInfoLight = -13,
	UIBorg_Daniel_Project4NativeItemInfoDark = -14,
	
	UIBorg_Daniel_Project4NativeItemDisclosure = -15,
	
	UIBorg_Daniel_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Borg_Daniel_Project4 instances of
