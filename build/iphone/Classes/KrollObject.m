...
//@interface Borg_Daniel_Project4Object : NSObject
//@end

@interface Borg_Daniel_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Borg_Daniel_Project4Object class]])
		{
			for (NSString *key in [[(Borg_Daniel_Project4Object*)o modules] allKeys])
			{
